...
<div class="bg-blue-50 relative overflow-hidden h-screen">
  ...
  <div class="container mx-auto w-full relative z-10 flex items-center justify-center mt-8">
      <div class="w-full md:w-1/2 py-16 mx-16">
          ...
          <li class="mt-10">
            <div class="flex">
              ...
              <div class="ml-4">
                ...
                <p class="mt-2 text-base leading-6 text-gray-500 dark:text-gray-300">
                  jQuery/&nbsp;React.js/&nbsp;Vue.js/&nbsp;laravel
                </p>
              </div>
            </div>
          </li>
